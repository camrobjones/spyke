...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 caL /Users/cameron/Development/camrobjones/spyke/data/models/x86_64/caL3d.mod\n");
...
static int  _f_rates (  double _lv ) {
   tad = pow( q10 , ( ( celsius - temp ) / 10.0 ) ) ;
   a = Ra / ( 1.0 + exp ( - ( _lv - th ) / q ) ) * tad ;
   b = Rb / ( 1.0 + exp ( ( _lv - th ) / q ) ) * tad ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/cameron/Development/camrobjones/spyke/data/models/caL3d.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
  "\n"
  "https://senselab.med.yale.edu/ModelDB/ShowModel?model=135787&file=/ShuEtAl20062007/caL3d.mod#tabs-2\n"
  "\n"
  ...
  "\n"
  "    tad = q10 ^ ((celsius - temp)/10 (degC))\n"
  "\n"
  "    a = Ra / (1 + exp(-(v-th)/q)) * tad\n"
  "    b = Rb / (1 + exp((v-th)/q)) * tad\n"
  "}\n"
  "\n"
