...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 CaT /Users/cameron/Development/camrobjones/spyke/data/models/x86_64/cat.mod\n");
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/cameron/Development/camrobjones/spyke/data/models/cat.mod";
static const char* nmodl_file_text = 
  "TITLE Calcium T channel for Subthalamic Nucleus\n"
  ":http://web.mit.edu/neuron_v7.4/nrntuthtml/tutorial/tutD.html\n"
  "\n"
  "UNITS {\n"
  "    (mV) = (millivolt)\n"
  "    (mA) = (milliamp)\n"
